...
export default function F(){
    return(
        ...
        <div className="flex justify-center flex-col items-center my-[8rem]">
            <h1 className="font-serif text-[64px] mb-8">&#91; f = face droop &#93;</h1>
            <div className="text-center text-[20px]">
                <p className="text-(--pink) pb-8">think and tell a funny &#40;inside&#41; joke</p>
            ...
            <motion.div
                ...
                <Image
                    src={grey}
                    alt="Asian woman with right face droop"
                    width={300}
                    height={300}
            ...
            <motion.div
                ...
                <Image
                    src={bow}
                    alt="Hispanic woman with left face droop"
                    width={300}
                    height={300}
                    className=""
                />
